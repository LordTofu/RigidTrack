...
\begin{DoxyCompactItemize}
\item 
comm\+Object \hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{comm\+Obj}
...
This file contains allmost all functional code for pose estimation, calibration and so on. The G\+UI related part is in \hyperlink{_rigid_track_8cpp}{Rigid\+Track.\+cpp} and the communication from \hyperlink{main_8cpp}{main.\+cpp} to G\+UI is done with the comm\+Obj class from \hyperlink{communication_8cpp_source}{communication.\+cpp}. \begin{DoxyAuthor}{Author}
Florian J.\+T. Wachter 
\end{DoxyAuthor}
...
240     corners.clear();
241 
242     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < boardSize.height; ++i)
243         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 0; j < boardSize.width; ++j)
244             corners.push\_back(Point3f(\textcolor{keywordtype}{float}(j*squareSize), \textcolor{keywordtype}{float}(i*squareSize), 0));
245 \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=332pt]{main_8cpp_a0a7f48017dbb3d64bfc1a171631ad7d7_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=321pt]{main_8cpp_a7ad2e3cfb5056dbab2098e0dd3bd353f_cgraph}
\end{center}
\end{figure}
...
As explained Euler angles can be extracted from an ordinary rotation matrix. As the Open\+CV documentation states the embedded function decompose\+Projection\+Matrix decomposes a projection matrix into a rotation matrix, camera matrix and Euler angles. But in Rigid Track rot\+Camer\+Matrix is always only a pure rotation matrix and the camera matrix equals the unit matrix. Get the euler angles from a rotation matrix 
\begin{DoxyParams}[1]{Parameters}
...
256                                                              \{
257 
258     Mat \hyperlink{main_8cpp_a53e8957a459b639ca82d938157f3b085}{cameraMatrix}, rotMatrix, transVect, rotMatrixX, rotMatrixY, rotMatrixZ;
259     \textcolor{keywordtype}{double}* \_r = rotCamerMatrix.ptr<\textcolor{keywordtype}{double}>();
260     \textcolor{keywordtype}{double} projMatrix[12] = \{ \_r[0],\_r[1],\_r[2],0,
261         \_r[3],\_r[4],\_r[5],0,
262         \_r[6],\_r[7],\_r[8],0 \};
263 
264     decomposeProjectionMatrix(Mat(3, 4, CV\_64FC1, projMatrix),
265         cameraMatrix,
266         rotMatrix,
267         transVect,
268         rotMatrixX,
269         rotMatrixY,
270         rotMatrixZ,
271         \hyperlink{main_8cpp_a0a53d01e06c71d6360afcb0fabf2aa8e}{eulerAngles});
272 \}
\end{DoxyCode}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\begin{center}
\leavevmode
\includegraphics[width=234pt]{main_8cpp_ad39626702ff983d5fdab4b703bfaf964_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=258pt]{main_8cpp_af39fa6c3a36ad6bc24a327db7a9d73c2_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=328pt]{main_8cpp_a56c7f641859cb2b6b99b0947d03be800_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=246pt]{main_8cpp_a56c7f641859cb2b6b99b0947d03be800_icgraph}
\end{center}
\end{figure}
...
168     RigidTrack w;
169     w.show();   \textcolor{comment}{//!< show the GUI}
170 \textcolor{comment}{}\textcolor{comment}{    //! connect the Qt slots and signals for event handling}
171 \textcolor{comment}{}    QObject::connect(&\hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}, SIGNAL(statusChanged(QString)), &w, SLOT(setStatus(QString)), 
      Qt::DirectConnection);
172     QObject::connect(&\hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}, SIGNAL(imageChanged(QPixmap)), &w, SLOT(setImage(QPixmap)), 
      Qt::DirectConnection);
173     QObject::connect(&\hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}, SIGNAL(logAdded(QString)), &w, SLOT(setLog(QString)), 
      Qt::DirectConnection);
174     QObject::connect(&\hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}, SIGNAL(logCleared()), &w, SLOT(clearLog(QString)), 
      Qt::DirectConnection);
175     QObject::connect(&\hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}, SIGNAL(P3Penabled(\textcolor{keywordtype}{bool})), &w, SLOT(enableP3P(\textcolor{keywordtype}{bool})), 
      Qt::DirectConnection);
176     QObject::connect(&\hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}, SIGNAL(progressUpdated(\textcolor{keywordtype}{int})), &w, SLOT(progressUpdate(\textcolor{keywordtype}{int})), 
      Qt::DirectConnection);
177 
178     \hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}.addLog(\textcolor{stringliteral}{"RigidTrack Version:"});
179     \hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}.addLog(QString::number(\_MSC\_FULL\_VER));
180     \hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}.addLog(\textcolor{stringliteral}{"Built on:"});
181     \hyperlink{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}{commObj}.addLog(QString(\_\_DATE\_\_));
182 \textcolor{comment}{}
183 \textcolor{comment}{    //! initial guesses for position and rotation, important for Iterative Method!}
184 \textcolor{comment}{}    \hyperlink{main_8cpp_a9215ba881de0242c883e5b065d6d2ff9}{Tvec}.at<\textcolor{keywordtype}{double}>(0) = 45;
185     \hyperlink{main_8cpp_a9215ba881de0242c883e5b065d6d2ff9}{Tvec}.at<\textcolor{keywordtype}{double}>(1) = 45;
186     \hyperlink{main_8cpp_a9215ba881de0242c883e5b065d6d2ff9}{Tvec}.at<\textcolor{keywordtype}{double}>(2) = 4500;
187     \hyperlink{main_8cpp_ae095f10a005e68d20233dc15b4077ca6}{Rvec}.at<\textcolor{keywordtype}{double}>(0) = 0 * 3.141592653589 / 180.0;
188     \hyperlink{main_8cpp_ae095f10a005e68d20233dc15b4077ca6}{Rvec}.at<\textcolor{keywordtype}{double}>(1) = 0 * 3.141592653589 / 180.0;
189     \hyperlink{main_8cpp_ae095f10a005e68d20233dc15b4077ca6}{Rvec}.at<\textcolor{keywordtype}{double}>(2) = -45 * 3.141592653589 / 180.0;
190 \textcolor{comment}{}
191 \textcolor{comment}{    //! Points that make up the marker CoSy axis system, hence one line in each axis direction}
192 \textcolor{comment}{}    \hyperlink{main_8cpp_ab34a04f5429de54d618fe1c9bd363c4e}{coordinateFrame} = std::vector<Point3d>(4);
193     \hyperlink{main_8cpp_a25a0b285905c7882d629b8f561425a2f}{coordinateFrameProjected} = std::vector<Point2d>(4);
...
198 
199     \hyperlink{main_8cpp_ac6dab448fd1f9b3aed1205fbd8179f5d}{position}[0] = 1.1234;     \textcolor{comment}{//!< set position initial values}
200 \textcolor{comment}{}    \hyperlink{main_8cpp_ac6dab448fd1f9b3aed1205fbd8179f5d}{position}[1] = 1.2345;     \textcolor{comment}{//!< set position initial values}
201 \textcolor{comment}{}    \hyperlink{main_8cpp_ac6dab448fd1f9b3aed1205fbd8179f5d}{position}[2] = 1.3456;     \textcolor{comment}{//!< set position initial values}
202 \textcolor{comment}{}
203     \hyperlink{main_8cpp_a700b8df52e2beb702d06651ed6130e73}{velocity}[0] = 0.123;    \textcolor{comment}{//!< set velocity initial values}
204 \textcolor{comment}{}    \hyperlink{main_8cpp_a700b8df52e2beb702d06651ed6130e73}{velocity}[1] = 0.234;    \textcolor{comment}{//!< set velocity initial values}
205 \textcolor{comment}{}    \hyperlink{main_8cpp_a700b8df52e2beb702d06651ed6130e73}{velocity}[2] = 0.345;    \textcolor{comment}{//!< set velocity initial values}
206 \textcolor{comment}{}
207     \hyperlink{main_8cpp_a0a53d01e06c71d6360afcb0fabf2aa8e}{eulerAngles}[0] = 1.002;  \textcolor{comment}{//!< set initial euler angles to arbitrary values for testing}
208 \textcolor{comment}{}    \hyperlink{main_8cpp_a0a53d01e06c71d6360afcb0fabf2aa8e}{eulerAngles}[1] = 1.003;  \textcolor{comment}{//!< set initial euler angles to arbitrary values for testing}
209 \textcolor{comment}{}    \hyperlink{main_8cpp_a0a53d01e06c71d6360afcb0fabf2aa8e}{eulerAngles}[2] = 1.004;  \textcolor{comment}{//!< set initial euler angles to arbitrary values for testing}
210 \textcolor{comment}{}
211     \hyperlink{main_8cpp_ad19da4e648bbdc80d3123eb94711588e}{setHeadingOffset}(0.0); \textcolor{comment}{//!< set the heading offset to 0 }
212 \textcolor{comment}{}
213     \hyperlink{main_8cpp_a8fc3524f4e679a41dcc8d0f302d637ed}{ss}.precision(4); \textcolor{comment}{//!< outputs in the log etc are limited to 3 decimal values}
214 \textcolor{comment}{}
215     \hyperlink{main_8cpp_af39fa6c3a36ad6bc24a327db7a9d73c2}{loadCameraPosition}(); \textcolor{comment}{//!< load the rotation matrix from camera CoSy to ground CoSy}
216 \textcolor{comment}{}    \hyperlink{main_8cpp_ad39626702ff983d5fdab4b703bfaf964}{loadCalibration}(0); \textcolor{comment}{//!< load the calibration file with the camera intrinsics}
217 \textcolor{comment}{}    \hyperlink{main_8cpp_a56c7f641859cb2b6b99b0947d03be800}{loadMarkerConfig}(0); \textcolor{comment}{//!< load the standard marker configuration}
218 \textcolor{comment}{}    \hyperlink{main_8cpp_a847c0fbd3e513fb76ff145b31a9f5c37}{testAlgorithms}(); \textcolor{comment}{//!< test the algorithms and their accuracy}
219 \textcolor{comment}{}
220     \textcolor{keywordflow}{return} a.exec();
221 \}
\end{DoxyCode}
Here is the call graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\begin{DoxyCode}
226 \{
227     QImage dest((\textcolor{keyword}{const} uchar *)src.data, src.cols, src.rows, src.step, QImage::Format\_RGB888);
228     dest.bits(); \textcolor{comment}{//! enforce deep copy, see documentation }
229 \textcolor{comment}{}\textcolor{comment}{                 //! of QImage::QImage ( const uchar * data, int width, int height, Format format )}
230 \textcolor{comment}{}    QPixmap pixmapDest = QPixmap::fromImage(dest);
231     \textcolor{keywordflow}{return} pixmapDest;
232 \}
\end{DoxyCode}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
...
\begin{center}
\leavevmode
\includegraphics[width=245pt]{main_8cpp_ad19da4e648bbdc80d3123eb94711588e_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=310pt]{main_8cpp_a1e6662e0f16887fe97c7bebe05065972_cgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=309pt]{main_8cpp_a3d3afd29ce54eb7fc5cc7e74ab666586_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=279pt]{main_8cpp_a3d3afd29ce54eb7fc5cc7e74ab666586_icgraph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=316pt]{main_8cpp_a847c0fbd3e513fb76ff145b31a9f5c37_cgraph}
\end{center}
\end{figure}
Here is the caller graph for this function\+:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=234pt]{main_8cpp_a847c0fbd3e513fb76ff145b31a9f5c37_icgraph}
\end{center}
\end{figure}
