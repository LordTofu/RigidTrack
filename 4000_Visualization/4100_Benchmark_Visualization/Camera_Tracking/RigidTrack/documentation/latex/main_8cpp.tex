\section{Rigid\+Track/main.cpp File Reference}
...
Q\+Pixmap \textbf{ Mat2\+Q\+Pixmap} (cv\+::\+Mat src)
...
void \textbf{ calc\+Board\+Corner\+Positions} (Size board\+Size, float square\+Size, std\+::vector$<$ Point3f $>$ \&corners)
...
void \textbf{ get\+Euler\+Angles} (Mat \&rot\+Camer\+Matrix, Vec3d \&\textbf{ euler\+Angles})
...
double \textbf{ time\+First\+Frame} = 0
...
Vec3d \textbf{ euler\+Angles} = Vec3d()
...
int \textbf{ int\+Frame\+Rate} = 100
\begin{DoxyCompactList}\small\item\em max is 480 increase if markers are badly visible but should be determined automatically during \doxyref{set\+Zero()}{p.}{main_8cpp_a7f3915653dcf5181fdc6e552ae8e6363} \end{DoxyCompactList}\item 
int \textbf{ int\+Threshold} = 200
\begin{DoxyCompactList}\small\item\em Co\+Sy rate of camera, maximum is 100 fps. \end{DoxyCompactList}\item 
Mat \textbf{ Rmat} = (cv\+::\+Mat\+\_\+$<$double$>$(3, 1) $<$$<$ 0.\+0, 0.\+0, 0.\+0)
...
Mat \textbf{ Rmat\+Ref} = (cv\+::\+Mat\+\_\+$<$double$>$(3, 3) $<$$<$ 1., 0., 0., 0., 1., 0., 0., 0., 1.)
\begin{DoxyCompactList}\small\item\em rotation matrix from camera Co\+Sy to marker Co\+Sy \end{DoxyCompactList}\item 
Mat \textbf{ M\+\_\+\+CN} = cv\+::\+Mat\+\_\+$<$double$>$(3, 3)
\begin{DoxyCompactList}\small\item\em reference rotation matrix from camera Co\+Sy to marker Co\+Sy \end{DoxyCompactList}\item 
Mat \textbf{ M\+\_\+\+Heading\+Offset} = cv\+::\+Mat\+\_\+$<$double$>$(3, 3)
...
Mat \textbf{ Rvec} = (cv\+::\+Mat\+\_\+$<$double$>$(3, 1) $<$$<$ 0.\+0, 0.\+0, 0.\+0)
...
Mat \textbf{ Tvec} = (cv\+::\+Mat\+\_\+$<$double$>$(3, 1) $<$$<$ 0.\+0, 0.\+0, 0.\+0)
...
bool \textbf{ use\+Guess} = true
\begin{DoxyCompactList}\small\item\em initial values as start values for algorithms and algorithm tests \end{DoxyCompactList}\item 
int \textbf{ method\+P\+NP} = 0
...
std\+::vector$<$ Point3d $>$ \textbf{ list\+\_\+points3d}
...
std\+::vector$<$ Point2d $>$ \textbf{ list\+\_\+points2d\+Projected}
...
std\+::vector$<$ Point2d $>$ \textbf{ list\+\_\+points2d\+Unsorted}
...
std\+::vector$<$ Point3d $>$ \textbf{ coordinate\+Frame}
...
double \textbf{ current\+Point\+Distance} = 5000
...
double \textbf{ min\+Point\+Distance} = 5000
...
bool \textbf{ camera\+\_\+started} = false
...
\mbox{\label{main_8cpp_a0a7f48017dbb3d64bfc1a171631ad7d7}} 
...
\subsubsection{calc\+Board\+Corner\+Positions()}
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a852329cf0943686665469e34f44a39bf}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a7ad2e3cfb5056dbab2098e0dd3bd353f}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_af2a8b7de0b15dc17198c147ba39e85f3}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a0416912fce6274568e80019b10ba294f}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a11ff459289305229597defd39f510959}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_af6430ad2592a955a3618549547dfc5be}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a44774828fee2764f3f3734bbd3f446e3}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_af39fa6c3a36ad6bc24a327db7a9d73c2}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a56c7f641859cb2b6b99b0947d03be800}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a2104a5d9d6b9f1e29bc4cd858c59882e}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a54b6b6db348b48d21e1265e22829c61f}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_ad19da4e648bbdc80d3123eb94711588e}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_ae624b0189bc5e32cbbb1f178b9f1a360}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a7f3915653dcf5181fdc6e552ae8e6363}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a7d029857f86ebf6ac36e9a73508699ad}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a2daa058d8e8204f4e0c51cd8f7d0f962}} 
...
\end{center}
\end{figure}
\mbox{\label{main_8cpp_a49aae6cc1a72ace00943d9226b5070b3}} 
...
\mbox{\label{main_8cpp_ae144f2eb508ffc763c259d875c600ab2}} 
...
\subsubsection{B\+A\+C\+K\+B\+U\+F\+F\+E\+R\+\_\+\+B\+I\+T\+S\+P\+E\+R\+P\+I\+X\+EL}
...
\mbox{\label{main_8cpp_a53e8957a459b639ca82d938157f3b085}} 
...
\mbox{\label{main_8cpp_af29e7fc07ae0979d5fb61b473241d33d}} 
...
\mbox{\label{main_8cpp_ab34a04f5429de54d618fe1c9bd363c4e}} 
...
\mbox{\label{main_8cpp_a25a0b285905c7882d629b8f561425a2f}} 
...
\subsubsection{coordinate\+Frame\+Projected}
...
\mbox{\label{main_8cpp_afe37bd67ad83a2d897cf5977cba70ef3}} 
...
\subsubsection{current\+Point\+Distance}
...
\mbox{\label{main_8cpp_ad44c6ce322034044d573e6d4678d630b}} 
...
\mbox{\label{main_8cpp_af38b495bf1b0e0651895215823059d30}} 
...
\mbox{\label{main_8cpp_a0a53d01e06c71d6360afcb0fabf2aa8e}} 
...
\mbox{\label{main_8cpp_ada7a8f4e3e45f929a512ffb0d9ff9012}} 
...
\mbox{\label{main_8cpp_aa5b833b78b107a1a04eb4edba151c0ba}} 
\index{main.\+cpp@{main.\+cpp}!int\+Frame\+Rate@{int\+Frame\+Rate}}
\index{int\+Frame\+Rate@{int\+Frame\+Rate}!main.\+cpp@{main.\+cpp}}
\subsubsection{int\+Frame\+Rate}
{\footnotesize\ttfamily int int\+Frame\+Rate = 100}



max is 480 increase if markers are badly visible but should be determined automatically during \doxyref{set\+Zero()}{p.}{main_8cpp_a7f3915653dcf5181fdc6e552ae8e6363} 

\mbox{\label{main_8cpp_a4e18b0b26ecc511ca7d2f2205313e537}} 
\index{main.\+cpp@{main.\+cpp}!int\+Intensity@{int\+Intensity}}
\index{int\+Intensity@{int\+Intensity}!main.\+cpp@{main.\+cpp}}
\subsubsection{int\+Intensity}
...
\mbox{\label{main_8cpp_a5cc3bd09f5801804b7ae65846e0b9824}} 
...
\mbox{\label{main_8cpp_ab97ac0d82b1753d0eef37089be17e5e1}} 
...
\mbox{\label{main_8cpp_afefb1102a8a4a71b55d6f24f46404cc5}} 
...
\mbox{\label{main_8cpp_a354806cf8cbface3575f2541d8fbcbda}} 
...
\mbox{\label{main_8cpp_aea88a68a83d84419dd1c5a93b21b1958}} 
...
\subsubsection{list\+\_\+points2d\+Difference}
...
\mbox{\label{main_8cpp_a85d3d8c8a0e3e9cfb6157c247470d934}} 
...
\subsubsection{list\+\_\+points2d\+Old}
...
\mbox{\label{main_8cpp_a7b88d0425a68875639d40a17079df819}} 
...
\subsubsection{list\+\_\+points2d\+Projected}
...
\mbox{\label{main_8cpp_a54cb682bd037283c18b5a9a447ff5e5e}} 
...
\subsubsection{list\+\_\+points2d\+Unsorted}
...
\mbox{\label{main_8cpp_a267046e6c367b4c2dec18b9b772ab67a}} 
...
\mbox{\label{main_8cpp_af604b9538ec8923428a78439eaf55f8e}} 
\index{main.\+cpp@{main.\+cpp}!M\+\_\+\+CN@{M\+\_\+\+CN}}
\index{M\+\_\+\+CN@{M\+\_\+\+CN}!main.\+cpp@{main.\+cpp}}
\subsubsection{M\+\_\+\+CN}
...
\mbox{\label{main_8cpp_a7b0c222d472eacfd5b0d73ed769baae0}} 
...
\subsubsection{M\+\_\+\+Heading\+Offset}
...
\mbox{\label{main_8cpp_ab5e634b66221f494504aea1557af5df9}} 
...
\mbox{\label{main_8cpp_ab826a7ca5876afdd6c0bccf04b73b30b}} 
...
\subsubsection{min\+Point\+Distance}
...
\mbox{\label{main_8cpp_ac06fee052099b9fc9f0826315bb64a4a}} 
...
\subsubsection{point\+Order\+Indices}
{\footnotesize\ttfamily int point\+Order\+Indices[$\,$] = \{ 0, 1, 2, 3 \}}



marker Co\+Sy projected from 3D to 2D camera image Co\+Sy 

\mbox{\label{main_8cpp_acc9e758efd664582db86f976cec195fa}} 
...
\subsubsection{point\+Order\+Indices\+New}
{\footnotesize\ttfamily int point\+Order\+Indices\+New[$\,$] = \{ 0, 1, 2, 3 \}}



old correspondence from list\+\_\+points3d and list\+\_\+points\+\_\+2d 

\mbox{\label{main_8cpp_a9a00043c93a3362969c1c1fcd3a70fea}} 
...
\mbox{\label{main_8cpp_a137bc8cc9d53ad9b176c988a99bc7142}} 
...
\mbox{\label{main_8cpp_a2601be9c226be24c71ec8282f632e723}} 
...
\mbox{\label{main_8cpp_ac6dab448fd1f9b3aed1205fbd8179f5d}} 
...
\mbox{\label{main_8cpp_adb13e6a4e95f0640adf01ada840748d9}} 
...
== Rotation, translation etc. matrix for PnP results \mbox{\label{main_8cpp_a4ee4d2abbe47b92c21b81c5c4389086e}} 
\index{main.\+cpp@{main.\+cpp}!Rmat\+Ref@{Rmat\+Ref}}
\index{Rmat\+Ref@{Rmat\+Ref}!main.\+cpp@{main.\+cpp}}
\subsubsection{Rmat\+Ref}
...
\mbox{\label{main_8cpp_ae095f10a005e68d20233dc15b4077ca6}} 
...
\mbox{\label{main_8cpp_a436fb814ccc3f02617dade4dc6511143}} 
...
\mbox{\label{main_8cpp_ae65386c3310ab826e84fba757296de9a}} 
...
\mbox{\label{main_8cpp_a2c1b807fcb2de5a6759bd60ccae6dd7e}} 
...
\mbox{\label{main_8cpp_aa6266eedab8b3c011be53baffbfc42ab}} 
...
\mbox{\label{main_8cpp_a8fc3524f4e679a41dcc8d0f302d637ed}} 
...
\mbox{\label{main_8cpp_a9215ba881de0242c883e5b065d6d2ff9}} 
...
IP adress of the circuit breaker that disables the object if a specified region is exited. \mbox{\label{main_8cpp_a6aa0c3a69dc10d5c4432dcf62e2155d3}} 
\index{main.\+cpp@{main.\+cpp}!udp\+Socket\+Safety@{udp\+Socket\+Safety}}
\index{udp\+Socket\+Safety@{udp\+Socket\+Safety}!main.\+cpp@{main.\+cpp}}
\subsubsection{udp\+Socket\+Safety}
...
\mbox{\label{main_8cpp_a4260e46da4e0e430642b2d8d8d3c7dd1}} 
...
\subsubsection{udp\+Socket\+Safety2}
...
\mbox{\label{main_8cpp_a700b8df52e2beb702d06651ed6130e73}} 
